            ...
            <div class="container middle bg-black btn-round">
                ...
                <form class="form-auth-small" action="/postregister" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input name="name" type="text" class="form-control " id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="new email">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1" class="text-light">Email address</label>
                        <input name="email" type="email" class="form-control " id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="new email">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <button type="submit" class="btn btn-danger btn-round float-left btn-full">Create</button>
                        </div>
                    </div>
                    <br>
                </form>
